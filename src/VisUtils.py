...
def write_ply(fn, point, feat_pred, normal=None, color=None):
    import open3d as o3d
    ...
    color={
            ...
            1: [255, 0, 0],  # plane         red
            3: [0, 255, 0],  # cone        green
            4: [0, 0, 255],  # cylinder   blue
            5: [255, 97, 0],  # sphere         orange

            2: [160,32,240],  # open b-spline  purple
            8: [160,32,240],  # Extrusion open b-spline  purple
            0: [192,192,192],  # Torus closed b-spline  gray
            6: [192,192,192],  # Other closed b-spline  gray
            7: [192,192,192],  # Revolution closed b-spline  gray
            9: [192,192,192],  # closed b-spline  gray
        }
    color = np.array([color[i] for i in feat_pred])
